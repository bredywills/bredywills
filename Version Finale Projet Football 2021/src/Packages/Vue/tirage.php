                    ...
                    <section class="<?= isset($_GET['tirage']) ? 'display_validation' : 'content' ?>">
                        ...
                        <table class="tablegroupes">
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo flag($myResult1->teteDeSerieA1);?>"> <?= $myResult1->teteDeSerieA1 ?></td>
                                <td><img src="<?php echo flag($myResult2->teteDeSerieB1);?>"> <?= $myResult2->teteDeSerieB1 ?></td>
                            </tr>

                            <tr>
                                <td>2<sup>e</sup> tete de serie (TDS)</td>
                                <td><img src="<?php echo flag($myResult1->teteDeSerieA2);?>"> <?= $myResult1->teteDeSerieA2 ?></td>
                                <td><img src="<?php echo flag($myResult2->teteDeSerieB2);?>"> <?= $myResult2->teteDeSerieB2 ?></td>
                            </tr>

                            <tr>
                                <td>3<sup>e</sup> tete de serie (TDS)</td>
                                <td><img src="<?php echo flag($myResult1->teteDeSerieA3);?>"> <?= $myResult1->teteDeSerieA3 ?></td>
                                <td><img src="<?php echo flag($myResult2->teteDeSerieB3);?>"> <?= $myResult2->teteDeSerieB3 ?></td>
                            </tr>

                            <tr>
                                <td>4<sup>e</sup> tete de serie (TDS)</td>
                                <td><img src="<?php echo flag($myResult1->teteDeSerieA4);?>"> <?= $myResult1->teteDeSerieA4 ?></td>
                                <td><img src="<?php echo flag($myResult2->teteDeSerieB4);?>"> <?= $myResult2->teteDeSerieB4 ?></td>
                            </tr>
                        </table>
                        </form>
                    </section>
